            ...
            Box(
                ...
                if (timers.isEmpty()) {
                    ...
                    LazyColumn(
                        ...
                        items(timers) { timer ->
                            TimerItem(timer = timer, onClick = { onTimerClick(timer.id) })
                        }
                    }
                }
            }
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    ...
                    style = MaterialTheme.typography.headlineMedium.copy(
                        fontWeight = FontWeight.Bold,
                        color = if (timer.isRunning) MaterialTheme.colorScheme.primary else Color(0xFF4F5B77)
                    )
                )
            }
